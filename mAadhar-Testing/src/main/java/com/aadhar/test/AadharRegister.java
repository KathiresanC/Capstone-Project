...
public class AadharRegister {
	...
	public void TestHome() {
		...
		webdriver.findElement(By.id("name")).sendKeys("Kathiresan");
		webdriver.findElement(By.id("dob")).sendKeys("19/07/2000");
		webdriver.findElement(By.id("emailid")).sendKeys("kathiresan@gmail.com");
		webdriver.findElement(By.id("address")).sendKeys("South Street,Salem");
		webdriver.findElement(By.id("mobileno")).sendKeys("9764887654");
